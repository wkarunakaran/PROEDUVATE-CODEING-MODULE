...
export default function Home({ user, stats }) {
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] text-center">
      <div className="text-xs font-semibold uppercase tracking-[0.3em] text-muted-foreground mb-2">
        ProEduvate
      </div>
      ...
      <div className="flex gap-3 mb-6">
        ...
        {!user && (
          <Link
            to="/login"
            className="px-5 py-2 rounded-full border border-border text-sm text-foreground hover:border-emerald-400"
          >
            Try as student
          </Link>
        )}
