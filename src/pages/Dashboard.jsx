  ...
  return (
    <div>
      <div className="grid md:grid-cols-[1.3fr,1.1fr] gap-4">
        <div className="rounded-2xl border border-emerald-500/40 bg-card/90 p-4">
          ...
          <div className="grid sm:grid-cols-2 gap-3 mb-4 text-xs">
            <div className="border border-border rounded-xl p-3">
              <div className="text-muted-foreground mb-1">Primary language</div>
          ...
          <div className="flex flex-wrap gap-3 text-xs">
            ...
            <Link
              to="/competitive"
              className="px-4 py-2 rounded-full border border-border text-foreground hover:border-emerald-400"
            >
            ...
            {problems.map((p) => {
              ...
              return (
                <Link
                  key={p.id}
                  to={`/workspace/${p.id}`}
                  className="block border border-border rounded-xl px-3 py-2 hover:border-emerald-500/80"
                >
                  <div className="flex justify-between gap-3">
                    <div>
                      ...
                      <div className="flex flex-wrap gap-1 mt-1">
                        ...
                        <span className="px-2 py-[2px] rounded-full text-[10px] border border-border text-muted-foreground">
                          {currentLanguage.toUpperCase()}
                        </span>
                      </div>
                    </div>
